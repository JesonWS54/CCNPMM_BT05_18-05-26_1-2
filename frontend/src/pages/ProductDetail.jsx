...
import { getProductDetailApi } from "../api/api";
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center gap-4 text-sm text-gray-500 flex-wrap">
              <span className="flex items-center gap-1">
                ...
                <span className="text-gray-400">({product.numReviews} đánh giá)</span>
              </span>
              <span className="text-gray-300">|</span>
              <span>
                Đã bán: <strong className="text-gray-700">{product.sold}</strong>
              </span>
            </div>
            ...
            <div className="flex items-center gap-3">
              <span className="text-gray-600 text-sm font-medium">Tình trạng:</span>
              {product.stock > 0 ? (
            ...
            {product.stock > 0 && (
              <div className="flex items-center gap-4">
                ...
                <span className="text-gray-400 text-sm">
                  Tổng: <strong className="text-orange-500">
